...
const FormClothes = () => {
  ...
  return (
    <section className="formClothes">
      <div
        className={
          step === 1 ? "formClothes__firstStep" : "formClothes__firstStep-hide"
        }
      >
      ...
      <div
        className={
          step === 3 ? "formClothes__thirdStep" : "formClothes__thirdStep-hide"
        }
      >
        <h1 className="formClothes__step">Krok {step}/5</h1>
      ...
      <div
        className={
          step === 5 ? "formClothes__fifthStep" : "formClothes__fifthStep-hide"
        }
      >
        <h1 className="formClothes__step">Krok {step}/5</h1>
        ...
        <h2>Oddajesz:</h2>
        <p>
          {formAnswer.select} {formAnswer.firstStep},{formAnswer.whoHelp}
        </p>
